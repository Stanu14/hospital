...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tbody><tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td width="25%" height="131" rowspan="2" class="navigation_bottom_border01" style="padding-left:25px;"><a href="index.php"><h1>Reception</h1></a></td>
        ...
        <td height="400"><table width="485" border="0" align="center" cellpadding="0" cellspacing="0">
          <tbody><tr>
            <td height="236" class="login-bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody><tr>
                <td>&nbsp;</td>
                <td class="heading-login"> Login Area</td>
              </tr>
              <tr>
                ...
                <td width="71%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3">
                  <tbody><tr>
                    <td height="30" colspan="2" class="heading-black">Please enter your login ID and password</td>
                    </tr>
                  <tr>
                    <td width="20%" align="right" class=" username" style="padding:7px;">Login Id:</td>
